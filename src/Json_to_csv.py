...
# take a json putput format from this project, and output the important info to a csv file
...
#   - number of ACU questions total
#   - number of ACU questions answered correctly
#   - boolean if the iteration ended with true or false in the judgment
